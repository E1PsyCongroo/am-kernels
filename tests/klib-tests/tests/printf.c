...
void int_test() {
    for (int i = 0; i < INTCASENUM; i++) {
        int ret = printf(int_test_case[i].format, int_test_case[i].data);
        printf("\n");
...
void uint_test() {
    for (int i = 0; i < UINTCASENUM; i++) {
        int ret = printf(uint_test_case[i].format, uint_test_case[i].data);
        printf("\n");
...
void ch_test() {
    for (int i = 0; i < CHCASENUM; i++) {
        int ret = printf(ch_test_case[i].format, ch_test_case[i].data);
        printf("\n");
...
void str_test() {
    for (int i = 0; i < STRCASENUM; i++) {
        int ret = printf(str_test_case[i].format, str_test_case[i].data);
        printf("\n");
...
void pointer_test() {
    for (int i = 0; i < POINTERCASENUM; i++) {
        int ret = printf(pointer_test_case[i].format, pointer_test_case[i].data);
        printf("\n");
